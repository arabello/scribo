...
import type { ChecklistAnalysisResult } from "~/model/checklist";
import { encodeChecklist, decodeChecklist } from "~/lib/markdown-converter";

interface ChecklistProps {
  content: string;
  onAnalysisComplete?: (result: ChecklistAnalysisResult) => void;
}
...
export default function Checklist({
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
    ...
    reader.onload = (event) => {
      ...
      if (markdown) {
        const importedItems = decodeChecklist(markdown);
        // Replace all items with imported ones in a single state update
